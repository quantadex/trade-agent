...
class LimitOrder {
	...
	isSameMarket(order) {
		return (order.sell_price.base.asset_id == this.sell_price.base.asset_id && 
						order.sell_price.quote.asset_id == this.sell_price.quote.asset_id)
	}
